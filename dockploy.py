...
API_URL = "http://65.2.160.111:3000//api/project.all"
api_key = "SszDzciMsQZPFWVxwPUhNCVROOceyYIJkNhXyjpMRhkbDcgxgHXetcDpWTmJfFPc"
app_name = "job-portal-backend-emajqn"
